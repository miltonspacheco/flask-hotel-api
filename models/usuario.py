...
from settings import MAILGUN_DOMAIN, MAILGUN_API_KEY, FROM_TITLE, FROM_EMAIL

class UserModel(banco.Model):
    __tablename__ = 'usuarios'

    user_id = banco.Column(banco.Integer, primary_key=True)
    login = banco.Column(banco.String(40), nullable=False, unique=True) # Não nulo e único
    ...
    def json(self):
        return {
            ...
            'login': self.login, # Nao faz sentido ter a senha no json
            'email': self.email,
