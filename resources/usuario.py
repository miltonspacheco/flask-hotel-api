...
atributos.add_argument('login', type=str, required=True, help="The field 'login' cannot be left blank.") #nao pode estar vazio
atributos.add_argument('senha', type=str, required=True, help="The field 'senha' cannot be left blank.") #nao pode estar vazio
    ...
    def delete(self, user_id):
        ...
        if user:
            try:
                ...
                return {'message': 'Error trying to delete user.'}, 500 #internal error
...
class UserRegister(Resource):
    ...
    def post(self):
        ...
        # Garante que seja False inicialmente 
        user.ativado = False
        try:
            user.save_user()    
...
class UserLogout(Resource):
    ...
    def post(self):
        ...
        return {'message': 'Logged out sucessfuly!'}, 200
